import { Search, SlidersHorizontal, Download, FileText, ChevronDown, Landmark } from 'lucide-react';

export function HistorialDescargasAutoridad() {
  // Datos simulados. Como ahora es un historial global, agregué la carrera al nombre del reporte para contexto.
  const descargas = [
    { nombre: 'Datos de Progresión Analítica - Ing. Civil en Informática', formato: 'Excel', periodo: 'Cohortes 2021–2026', fecha: '18 ago, 2026 · 09:42', tamano: '24 KB' },
    { nombre: 'Datos de Progresión Curricular - Arquitectura', formato: 'PDF', periodo: 'Cohortes 2021–2025', fecha: '17 ago, 2026 · 16:18', tamano: '188 KB' },
    { nombre: 'Datos de Progresión Analítica - Auditoría', formato: 'PDF', periodo: 'Cohortes 2017–2026', fecha: '12 ago, 2026 · 11:06', tamano: '214 KB' },
    { nombre: 'Datos de Progresión Curricular - Derecho', formato: 'Excel', periodo: 'Cohortes 2021–2025', fecha: '04 ago, 2026 · 14:31', tamano: '21 KB' },
    { nombre: 'Reporte Institucional Global - Sede Valdivia', formato: 'PDF', periodo: '2026', fecha: '28 jul, 2026 · 10:12', tamano: '2.4 MB' },
  ];
    ...
    <div className="mx-auto max-w-[1440px] space-y-10 p-5 sm:p-8 lg:p-10 bg-[#F8FAFC] min-h-screen">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500 max-w-2xl">
          Historial general de archivos y reportes generados desde el panel de autoridad.
        </p>
      </div>
      ...
      <section className="grid gap-4 sm:grid-cols-3">
        ...
        <div className="rounded-xl border border-slate-200/80 bg-white p-6 shadow-sm">
          ...
          <p className="text-xs text-slate-400 mt-1">Progresión Analítica (Informática)</p>
        </div>
        <div className="rounded-xl border border-slate-200/80 bg-white p-6 shadow-sm">
