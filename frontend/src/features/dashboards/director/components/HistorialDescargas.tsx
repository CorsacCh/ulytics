import { Search, SlidersHorizontal, Download, FileText, ChevronDown } from 'lucide-react';

export function HistorialDescargas() {
  const descargas = [
    { nombre: 'Datos de Progresión Analítica', formato: 'Excel', periodo: 'Cohortes 2021–2026', fecha: '18 ago, 2026 · 09:42', tamano: '24 KB' },
    { nombre: 'Datos de Progresión Curricular', formato: 'PDF', periodo: 'Cohortes 2021–2025', fecha: '17 ago, 2026 · 16:18', tamano: '188 KB' },
    { nombre: 'Datos de Progresión Analítica', formato: 'PDF', periodo: 'Cohortes 2017–2026', fecha: '12 ago, 2026 · 11:06', tamano: '214 KB' },
    { nombre: 'Datos de Progresión Curricular', formato: 'Excel', periodo: 'Cohortes 2021–2025', fecha: '04 ago, 2026 · 14:31', tamano: '21 KB' },
    { nombre: 'Datos de Progresión Analítica', formato: 'Excel', periodo: 'Cohortes 2017–2026', fecha: '28 jul, 2026 · 10:12', tamano: '25 KB' },
  ];
  ...
  return (
    <div className="mx-auto max-w-[1440px] space-y-10 p-5 sm:p-8 lg:p-10 bg-[#F8FAFC] min-h-screen">
      ...
      <div>
        ...
        <h1 className="text-3xl font-bold text-[#0A192F]">Historial de descargas</h1>
        <p className="mt-1 text-sm text-slate-500">
          Registro de archivos generados y descargados por la dirección de Ingeniería Civil Informática.
        </p>
      </div>
